...
function Footer() {
  return (
    <footer className="bg-[#1B1B32] pt-40 mt-32">
      <div className="bg-[#0C6EFD] py-12 w-[80%] -m-52 text-white md:px-32 items-center gap-12 mx-auto rounded-2xl flex max-md:flex-col">
        <h1 className="font-Rubik text-3xl">¡Hablemos!</h1>
        <p className=" w-[300px] max-md:w-[200px] max-md:mx-auto max-md:text-sm mx-auto text-center">
      ...
      <div className="mt-64 grid items-center justify-center">
        ...
        <p className="w-[400px] mx-auto text-center font-bold text-2xl text-white">
          Aprendo y creo todos los dias. Creemos un proyecto juntos{" "}
        </p>
        ...
        <p className="text-center text-white text-xl py-12">Creado por Santiago Suescun (2024) ©</p>
      </div>
    </footer>
  );
}
